...
unzip lmo_models.zip -d lm     # Unpacks to "lmo".
unzip lmo_train_pbr.zip -d lm  # Unpacks to "lmo".
unzip lmo_train.zip -d lm   # Unpacks to "lmo".
unzip lmo_test_all.zip -d lm  # Unpacks to "lmo".
unzip lmo_test_bop_19.zip -d lm  # Unpacks to "lmo".
