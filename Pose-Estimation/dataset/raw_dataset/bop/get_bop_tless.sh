...
unzip tless_models.zip -d lm     # Unpacks to "tless".
unzip tless_train_pbr.zip -d lm  # Unpacks to "tless".
unzip tless_train_render_reconst.zip -d lm   # Unpacks to "tless".
unzip tless_train_primesense.zip -d lm  # Unpacks to "tless".
unzip tless_test_primesense_all.zip -d lm  # Unpacks to "tless".
unzip tless_test_primesense_bop19.zip -d lm  # Unpacks to "tless".
